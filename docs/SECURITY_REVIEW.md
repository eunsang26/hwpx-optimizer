...
- 배포 공지에는 버전, 배포일, 담당자, 변경 내역, SHA256 값, 자체서명 상태, 제작자/사용 조건, 보증 부인 및 사용자 책임 문구를 포함한다.
...
- 현재 Windows 배포 파일은 자체서명 배포본이며, Windows 게시자 신뢰 경고 가능성과 실행 전 SHA256 대조 확인이 필요하다.
